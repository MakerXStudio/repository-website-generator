    ...
    <li>
      <Link href={slug}>
        <a
          className={
            selected
              ? `inline-block py-2 px-3 text-lg ${insideResponsiveMenu ? 'text-black' : 'text-white'} underline underline-offset-8 decoration-2 font-bold pointer-events-none`
              : `inline-block py-2 px-3 text-lg ${
	...
	l-214.375,73.99V218.377l214.375-80.271V367.435z"
        ...
        >
          ...
          <a
            ...
            className="inline-block mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-2 px-4 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
            {/* MIT License https://www.svgrepo.com/svg/344880/github */}
            <svg x="0px" y="0px" viewBox="0 0 16 16" className="h-6 fill-gray-700 inline pr-4">
